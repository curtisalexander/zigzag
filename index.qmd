...
<details open class="tangent">
<summary>![](images/socrates.webp){.tangent-icon} ↯ On tangents</summary>
...
<summary>![](images/socrates.webp){.tangent-icon} ↯ Starting from nothing</summary>
...
That's it. Three tools. If you can open a terminal, you can do this. (Exact versions and how the pieces fit together are in the [Colophon](chapters/colophon.qmd).)
